...
--    telescope.load_extension("git_conflicts")
    ...
    keymap.set("n", "<leader>ff", "<cmd>Telescope find_files<cr>", { desc = "Fuzzy find files in cwd" })
		...
		keymap.set("n", "<leader>fS", function() require('ace.telescopePickers').prettyGrepPicker({ picker = 'grep_string' }) end, { desc = "Find string under cursor in cwd" })
    ...
    keymap.set('n', '<leader>fb', function() pickers.prettyBuffersPicker() end )
    keymap.set('n', '<leader>fd', function() pickers.prettyDocumentSymbols() end)
    keymap.set('n', '<leader>fw', function() pickers.prettyWorkspaceSymbols() end )
	end,
}
